...
<div class="admin-container">
    ...
    <div class="main-content">
        ...
        <div class="dashboard-stats" style="grid-template-columns:repeat(auto-fit,minmax(200px,1fr));display:grid;gap:20px;margin-bottom:30px;">
            <div class="stat-card" style="background:white;padding:20px;border-radius:10px;box-shadow:0 5px 15px rgba(0,0,0,0.05);">
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    <div>
                        <h3 style="margin:0;font-size:1rem;color:#666;">Total Users</h3>
                        <div class="stat-number" style="font-size:2rem;font-weight:bold;color:var(--primary-color);"><?php echo $user_count; ?></div>
                    </div>
            ...
            <div class="stat-card" style="background:white;padding:20px;border-radius:10px;box-shadow:0 5px 15px rgba(0,0,0,0.05);">
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    <div>
                        ...
                        <div class="stat-number" style="font-size:2rem;font-weight:bold;color:var(--secondary-color);"><?php echo $order_count; ?></div>
                    </div>
            ...
            <div class="stat-card" style="background:white;padding:20px;border-radius:10px;box-shadow:0 5px 15px rgba(0,0,0,0.05);">
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    <div>
                        ...
                        <div class="stat-number" style="font-size:2rem;font-weight:bold;color:var(--accent-color);"><?php echo $prescription_count; ?></div>
                    </div>
            ...
            <div class="stat-card" style="background:white;padding:20px;border-radius:10px;box-shadow:0 5px 15px rgba(0,0,0,0.05);">
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    <div>
                        ...
                        <div class="stat-number" style="font-size:2rem;font-weight:bold;color:#0984e3;"><?php echo $medicine_count; ?></div>
                    </div>
        ...
        <div style="background:white;padding:25px;border-radius:8px;box-shadow:0 5px 15px rgba(0,0,0,0.05);">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                ...
                <a href="/ease-meds/admin/orders.php" class="btn" style="background:var(--primary-color);color:white;padding:10px 15px;border-radius:5px;text-decoration:none;">View All Orders</a>
            </div>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    $badge = 'badge-' . strtolower($row['status']);
                    echo "<tr>
                            <td>#" . $row['id'] . "</td>
